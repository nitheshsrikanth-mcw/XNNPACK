...
class RAddStoreExpMinusMaxMicrokernelTester {
 ...
 #define XNN_TEST_RADDSTOREEXPMINUSMAX_BATCH_EQ(ukernel,arch_flags, element_tile, ...)                                                \
  TEST(ukernel, batch_eq) {                                                                          \
    RAddStoreExpMinusMaxMicrokernelTester()                                                                    \
      .elements(element_tile)                                                                         \
      .Test(ukernel,__VA_ARGS__);                                                                              \
  }
#define XNN_TEST_RADDSTOREEXPMINUSMAX_BATCH_DIV(ukernel,arch_flags, element_tile, ...)                                                 \
...
#define XNN_TEST_RADDSTOREEXPMINUSMAX_BATCH_LT(ukernel,arch_flags, element_tile, ...)                                                 \
...
#define XNN_TEST_RADDSTOREEXPMINUSMAX_BATCH_GT(ukernel,arch_flags, element_tile, ...)                                                \
