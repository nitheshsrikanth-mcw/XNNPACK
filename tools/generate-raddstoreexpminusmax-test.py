...
XNN_TEST_RADDSTOREEXPMINUSMAX_BATCH_EQ(ukernel,arch_flags, ${", ".join(TEST_ARGS)});  
XNN_TEST_RADDSTOREEXPMINUSMAX_BATCH_DIV(ukernel,arch_flags,  ${", ".join(TEST_ARGS)});
XNN_TEST_RADDSTOREEXPMINUSMAX_BATCH_LT(ukernel,arch_flags,  ${", ".join(TEST_ARGS)});
XNN_TEST_RADDSTOREEXPMINUSMAX_BATCH_GT(ukernel,arch_flags,  ${", ".join(TEST_ARGS)});
"""
