...
tools/generate-raddstoreexpminusmax-test.py --tester RAddStoreExpMinusMicrokernelTester --ukernel f32-raddstoreexpminusmax --output test/f32-raddstoreexpminusmax.cc &
